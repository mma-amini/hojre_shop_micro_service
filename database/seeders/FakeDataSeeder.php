...
class FakeDataSeeder extends Seeder {
    ...
    public function run() {
        ...
        DB::table('options')->insert([
                                         ...
                                         'option_name' => 'نیرو محرکه',
                                     ]);

        DB::table('option_items')->insert([
                                              'id'        => '0784c2fc-3a4c-49d2-87f6-6cde2f975661',
                                              'option_id' => 'dbc77533-7109-42f9-9f22-800fd2fbe85e',
        ...
        DB::table('option_items')->insert([
                                              ...
                                              'option_id' => 'beaff629-1f43-4ba6-afdb-b84378585f68',
        ...
        DB::table('option_items')->insert([
                                              ...
                                              'option_id' => '8d2d1eb0-9b98-4068-ab4f-3fae57866a6c',
                                              'input_id'  => '7783d108-c031-4f97-8d81-edeb753d6d97',
                                              'name'      => 'نوع موتور',
                                          ]);

        DB::table('option_values')->insert([
                                               'id'    => '0539f118-63b4-4458-932a-1415cfc1978f',
                                               'title' => 'Android',
                                           ]);

        DB::table('option_values')->insert([
                                               'id'    => '62c3aab3-fe8e-4159-8861-31f6391d7d5b',
                                               'title' => 'iOS',
                                           ]);

        DB::table('option_values')->insert([
                                               'id'    => '1eb7e0d9-bd8c-4ea2-a59d-a94d9400add6',
                                               'title' => 'Windows',
                                           ]);
